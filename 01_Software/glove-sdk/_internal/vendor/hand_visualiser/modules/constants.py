...
hand_joint_fa = np.asarray([-1, 0, 1, 2, 0, 4, 5, 0, 7, 8, 0, 10, 11, 0, 13, 14], dtype=int)
hand_joint_fa_root = 0

# base rotation of hand coordinate system, deprecated, keep for reference
...
# FIVE
hand_model_pose_0 = np.zeros(shape=(48,))

# THUMB_UP
hand_model_pose_1 = np.array([
    [0.0, 0.0, 0.0],
...
trivial_hand_pose = R.from_rotvec(np.zeros(shape=(16, 3)))
trivial_hand_tensor = torch.zeros(16, 3)
